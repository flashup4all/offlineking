<template>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <button class="btn btn-purple-gradient btn-rounded"> <i class="fas fa-plus"></i> Create New Design</button>
          </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1 my-3">
              <button class="btn btn-purple-gradient btn-rounded" data-toggle="modal" data-target="#Upgrade" href="#"
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img v-if="url" :src="url" class="img-profile rounded-circle" />
                <img v-if="!url" class="img-profile rounded-circle" src="../../assets/img/user.jpg">
              </a>
